    ...
    <div className="space-y-3">
      <div className="flex flex-col gap-3">
        {data.map((day) => (
          ...
          >
            <p style={{ fontFamily: 'BMWTypeNext', fontSize: '12px', fontWeight: 600, color: '#9898A8' }}>
            ...
            {hasAnyData(day) ? (
              ...
              <p style={{ fontFamily: 'BMWTypeNext', fontSize: '12px', color: '#606070' }}>No WHOOP data found for this date.</p>
            )}
          </div>
        ))}
      </div>
...
function WhoopStat({ label, value, valueColor }: WhoopStatProps) {
  return (
    <span>
      <span style={{ fontFamily: 'BMWTypeNext', fontSize: '11px', color: '#606070' }}>{label}: </span>
